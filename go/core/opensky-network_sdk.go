...
func (sdk *OpenskyNetworkSDK) OptionsMap() map[string]any {
...
func (sdk *OpenskyNetworkSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenskyNetworkSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenskyNetworkSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenskyNetworkSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenskyNetworkSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenskyNetworkSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenskyNetworkSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenskyNetworkSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenskyNetworkSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenskyNetworkSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenskyNetworkSDK {
	...
	sdk := NewOpenskyNetworkSDK(sdkopts)
	sdk.Mode = "test"
