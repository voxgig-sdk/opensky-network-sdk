...
// instead of `sdk.NewOpenskyNetworkSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpenskyNetworkSDK  { return NewOpenskyNetworkSDK(nil) }
func Test() *OpenskyNetworkSDK { return TestSDK(nil, nil) }
