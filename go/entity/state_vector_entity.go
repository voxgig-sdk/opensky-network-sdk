...
func NewStateVectorEntity(client *core.OpenskyNetworkSDK, entopts map[string]any) *StateVectorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StateVectorEntity) GetName() string { return e.name }
...
func (e *StateVectorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StateVectorEntity) Deleted() bool {
	return e.deleted
}


func (e *StateVectorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStateVectorEntity(e.client, opts)
}

func (e *StateVectorEntity) Data(args ...any) any {
...
func (e *StateVectorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StateVector; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StateVectorEntity) DataTyped(data ...StateVector) StateVector {
	if len(data) > 0 {
		return typedFrom[StateVector](e.Data(asMap(data[0])))
	}
	return typedFrom[StateVector](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StateVector (all fields
// optional at the wire level).
func (e *StateVectorEntity) MatchTyped(match ...StateVector) StateVector {
	if len(match) > 0 {
		return typedFrom[StateVector](e.Match(asMap(match[0])))
	}
	return typedFrom[StateVector](e.Match())
}
...
func (e *StateVectorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StateVectorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StateVectorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StateVectorListMatch and returns []StateVector. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StateVectorEntity) ListTyped(reqmatch StateVectorListMatch, ctrl map[string]any) ([]StateVector, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[StateVector](res), nil
}



func (e *StateVectorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StateVectorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StateVectorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StateVectorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
