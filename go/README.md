...
## Install
```bash
go get github.com/voxgig-sdk/opensky-network-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/opensky-network-sdk=../path/to/github.com/voxgig-sdk/opensky-network-sdk
```
...
```
github.com/voxgig-sdk/opensky-network-sdk/
...
The root package (`github.com/voxgig-sdk/opensky-network-sdk`) re-exports everything needed
