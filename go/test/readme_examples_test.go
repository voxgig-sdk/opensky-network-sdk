...
const testSeed = `map[string]any{"entity": map[string]any{"flight": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "state_vector": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "track": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
