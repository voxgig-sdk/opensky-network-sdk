...
class FlightEntity extends OpenskyNetworkEntityBase_1.OpenskyNetworkEntityBase {
    ...
    make() {
        return new FlightEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Flight[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=FlightEntity.js.map