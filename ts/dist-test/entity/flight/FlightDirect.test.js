...
(0, node_test_1.describe)('FlightDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-flight', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-flight', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['OPENSKY_NETWORK_TEST_FLIGHT_ENTID'];
...
//# sourceMappingURL=FlightDirect.test.js.map