...
(0, node_test_1.describe)('StateVectorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenskyNetworkSDK({
    ...
    (0, node_test_1.test)('direct-list-state_vector', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-state_vector', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OPENSKY_NETWORK_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenskyNetworkSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.OPENSKY_NETWORK_APIKEY,
            secret: env.OPENSKY_NETWORK_SECRET,
        }));
        let idmap = env['OPENSKY_NETWORK_TEST_STATE_VECTOR_ENTID'];
    ...
    const client = new __1.OpenskyNetworkSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=StateVectorDirect.test.js.map