...
describe("TrackDirect", function()
  it("should direct-list-track", function()
    local setup = track_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-track", setup.live and "live" or "unit")
