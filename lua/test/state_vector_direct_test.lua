...
describe("StateVectorDirect", function()
  it("should direct-list-state_vector", function()
    local setup = state_vector_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-state_vector", setup.live and "live" or "unit")
...
function state_vector_direct_setup(mockres)
