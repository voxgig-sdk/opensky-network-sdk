...
describe("FlightDirect", function()
  it("should direct-list-flight", function()
    local setup = flight_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-flight", setup.live and "live" or "unit")
...
function flight_direct_setup(mockres)
