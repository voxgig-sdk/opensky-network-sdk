...
function runner.env_override(m)
  local live = runner.getenv("OPENSKYNETWORK_TEST_LIVE")
  local override = runner.getenv("OPENSKYNETWORK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENSKYNETWORK_TEST_EXPLAIN")
