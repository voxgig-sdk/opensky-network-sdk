...
function runner.env_override(m)
  local live = runner.getenv("OPENSKY_NETWORK_TEST_LIVE")
  local override = runner.getenv("OPENSKY_NETWORK_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENSKY_NETWORK_TEST_EXPLAIN")
