...
from openskynetwork_sdk.utility import register

# Load features
from openskynetwork_sdk.feature.base_feature import OpenskyNetworkBaseFeature
from openskynetwork_sdk.features import _has_feature, _make_feature
...
class OpenskyNetworkSDK:
    ...
    def get_utility(self):
        return OpenskyNetworkUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenskyNetworkSDK: graphql: " + str(msg))
            res["graphql"] = errors
