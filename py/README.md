...
| `callsign` | `str` | Callsign of the vehicle (8 chars) |
| `departureAirportCandidatesCount` | `int` | Number of candidates for departure airport |
| `estArrivalAirport` | `str` | Estimated arrival airport ICAO code |
...
| `estDepartureAirport` | `str` | Estimated departure airport ICAO code |
...
| Field | Type | Description |
| --- | --- | --- |
| `callsign` | `str` | Callsign of the vehicle |
| `endTime` | `int` | Unix timestamp (seconds) of the end of the track |
| `icao24` | `str` | Unique ICAO 24-bit address of the transponder |
| `path` | `list` | Array of waypoints representing the aircraft trajectory |
