...
class TestTrackDirect:
    ...
    def test_should_direct_list_track(self):
        setup = _track_direct_setup([
            {"id": "direct01"},
            {"id": "direct02"},
        ])
        _skip, _reason = runner.is_control_skipped("direct", "direct-list-track", "live" if setup["live"] else "unit")
        if _skip:
