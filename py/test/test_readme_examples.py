# OpenskyNetwork SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenskyNetworkSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenskyNetworkSDK(...) and OpenskyNetworkSDK.test(...) become
#      OpenskyNetworkSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openskynetwork_sdk"
_SDK_CLASS = "OpenskyNetworkSDK"
