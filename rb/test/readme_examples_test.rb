...
#      offline in seeded test mode (OpenskyNetworkSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenskyNetwork_sdk.rb")
  SDK_CLASS = "OpenskyNetworkSDK"
