...
class FlightEntity
  ...
  # @return [Flight, Hash] the current Flight data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Flight fields)
  def match_get
  ...
  #
  # @param reqmatch [FlightListMatch, Hash, nil] match filter (any subset of
  #   Flight fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Flight>, Array] the matching Flight items; raises OpenskyNetworkError on failure
