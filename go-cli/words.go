...
func registerSDKWords(r *eng.Registry, client *sdk.OpenskyNetworkSDK) {
...
func runOp(client *sdk.OpenskyNetworkSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
