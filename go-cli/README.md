...
AQL-driven CLI and REPL for the OpenskyNetwork SDK. Positional arguments are
...
```sh
go build -o opensky-network-cli ./...
```
...
./opensky-network-cli load 1 flight
./opensky-network-cli load '{id:1}' flight
