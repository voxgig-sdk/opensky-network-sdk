// Command OpenskyNetwork-cli is a CLI + REPL for the OpenskyNetwork SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      OPENSKY_NETWORK_APIKEY (api key), OPENSKY_NETWORK_BASE (base url override)")
