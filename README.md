...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/opensky-network` | `npm install @voxgig-sdk/opensky-network` |
| Python | `voxgig-sdk-opensky-network` | `pip install voxgig-sdk-opensky-network` |
| PHP | `voxgig-sdk/opensky-network` | `composer require voxgig-sdk/opensky-network` |
| Golang | `github.com/voxgig-sdk/opensky-network-sdk/go` | `go get github.com/voxgig-sdk/opensky-network-sdk/go` |
| Ruby | `voxgig-sdk-opensky-network` | `gem install voxgig-sdk-opensky-network` |
| Lua | `voxgig-sdk-opensky-network` | `luarocks install voxgig-sdk-opensky-network` |
