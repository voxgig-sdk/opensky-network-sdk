...
|---|---|---|
| `ts/` | @voxgig-sdk/opensky-network-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/opensky-network-sdk \
      --repository voxgig-sdk/opensky-network-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/opensky-network-sdk` shows it, and
`npm trust revoke @voxgig-sdk/opensky-network-sdk --id=<id>` removes it.
