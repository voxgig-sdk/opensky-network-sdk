...
// OpenskyNetwork SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpenskyNetworkTransformResponse
{
    public static function call(OpenskyNetworkContext $ctx): mixed
    {
        ...
        $transform = OpenskyNetworkHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
