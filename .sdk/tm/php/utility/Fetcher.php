...
// OpenskyNetwork SDK utility: fetcher

class OpenskyNetworkFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenskyNetworkSDK/1.0)';
    ...
    public static function call(OpenskyNetworkContext $ctx, string $fullurl, array $fetchdef): array
    {
