...
// OpenskyNetwork SDK cache feature
...
class OpenskyNetworkCacheFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _through(OpenskyNetworkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
