...
// OpenskyNetwork SDK proxy feature
...
class OpenskyNetworkProxyFeature extends OpenskyNetworkBaseFeature
{
    ...
    public function init(OpenskyNetworkContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenskyNetworkContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
