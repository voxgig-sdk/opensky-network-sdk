...
// OpenskyNetwork SDK metrics feature
...
class OpenskyNetworkMetricsFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _record(OpenskyNetworkContext $ctx, bool $ok): void
    {
