...
// OpenskyNetwork SDK streaming feature
...
class OpenskyNetworkStreamingFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _iterate(OpenskyNetworkResult $result): \Generator
    {
    ...
    private function _streamable(OpenskyNetworkContext $ctx): bool
    {
