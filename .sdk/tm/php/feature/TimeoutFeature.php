...
// OpenskyNetwork SDK timeout feature
...
class OpenskyNetworkTimeoutFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _with_timeout(OpenskyNetworkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenskyNetworkContext $_ctx, float $ms): void
    {
        $client = $this->client;
