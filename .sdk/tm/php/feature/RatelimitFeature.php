...
// OpenskyNetwork SDK ratelimit feature
...
class OpenskyNetworkRatelimitFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _acquire(OpenskyNetworkContext $ctx): void
    {
    ...
    private function _track(OpenskyNetworkContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
