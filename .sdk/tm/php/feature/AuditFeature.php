...
// OpenskyNetwork SDK audit feature
...
class OpenskyNetworkAuditFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _emit(OpenskyNetworkContext $ctx, string $outcome): void
    {
