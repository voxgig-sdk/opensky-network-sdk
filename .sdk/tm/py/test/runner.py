...
class OpenskyNetworkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenskyNetworkTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OpenskyNetworkTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OpenskyNetworkTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
