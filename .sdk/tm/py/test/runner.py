...
class OpenskyNetworkTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenskyNetworkTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenskyNetworkTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenskyNetworkTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
