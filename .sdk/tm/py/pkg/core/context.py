...
from projectname_sdk.core.control import OpenskyNetworkControl
...
class OpenskyNetworkContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = OpenskyNetworkControl()
        ...
        if isinstance(sp, OpenskyNetworkSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OpenskyNetworkResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpenskyNetworkResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return OpenskyNetworkOperation({})
    ...
    def make_error(self, code, msg):
        return OpenskyNetworkError(code, msg, self)
