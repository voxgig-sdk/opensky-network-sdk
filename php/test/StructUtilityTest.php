...
// OpenskyNetwork SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OpenskyNetworkOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OpenskyNetworkOmni::structfix($now, Struct::undef()))
                        !== json_encode(OpenskyNetworkOmni::structfix($val, Struct::undef()))) {
