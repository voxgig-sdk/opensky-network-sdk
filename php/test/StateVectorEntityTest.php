...
class StateVectorEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENSKYNETWORK_TEST_STATE_VECTOR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function state_vector_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENSKYNETWORK_TEST_STATE_VECTOR_ENTID");
