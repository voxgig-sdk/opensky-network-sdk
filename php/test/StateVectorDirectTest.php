...
class StateVectorDirectTest extends TestCase
{
    public function test_direct_list_state_vector(): void
    {
        $setup = state_vector_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-state_vector", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
