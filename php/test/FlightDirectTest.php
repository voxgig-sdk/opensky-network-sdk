...
class FlightDirectTest extends TestCase
{
    public function test_direct_list_flight(): void
    {
        $setup = flight_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-flight", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
