...
// OpenskyNetwork SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenskyNetworkSDK::test)
...
{
    private const SDK_CLASS = 'OpenskyNetworkSDK';
    ...
    private const SDK_BASE = 'openskynetwork_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openskynetwork_sdk.php';
