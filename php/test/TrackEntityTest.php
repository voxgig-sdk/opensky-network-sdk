...
class TrackEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENSKYNETWORK_TEST_TRACK_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function track_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENSKYNETWORK_TEST_TRACK_ENTID");
