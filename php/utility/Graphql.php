...
// OpenskyNetwork SDK utility: graphql
//
...
class OpenskyNetworkGraphql
{
    ...
    // equivalent.
    public static function body(OpenskyNetworkContext $ctx): mixed
    {
    ...
    public static function errors(OpenskyNetworkContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
