...
// OpenskyNetwork SDK utility: make_options

class OpenskyNetworkMakeOptions
{
    ...
    public static function call(OpenskyNetworkContext $ctx): array
    {
        ...
        //
        // `OpenskyNetworkSchema::optspec()` is built from the model:
        ...
        $optspec = OpenskyNetworkSchema::optspec();
