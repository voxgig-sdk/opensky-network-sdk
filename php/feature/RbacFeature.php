...
// OpenskyNetwork SDK rbac feature
...
class OpenskyNetworkRbacFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _required(OpenskyNetworkContext $ctx): ?string
    {
    ...
    private function _reject(OpenskyNetworkContext $ctx, string $required): void
    {
    ...
    private function _track(OpenskyNetworkContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
