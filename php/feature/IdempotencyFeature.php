...
// OpenskyNetwork SDK idempotency feature
...
class OpenskyNetworkIdempotencyFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _mutating(OpenskyNetworkContext $ctx): bool
    {
