...
// OpenskyNetwork SDK clienttrack feature
...
class OpenskyNetworkClienttrackFeature extends OpenskyNetworkBaseFeature
{
    ...
    public function PostConstruct(OpenskyNetworkContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenskyNetwork-SDK';
