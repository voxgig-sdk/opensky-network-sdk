...
// OpenskyNetwork SDK netsim feature
...
class OpenskyNetworkNetsimFeature extends OpenskyNetworkBaseFeature
{
    ...
    private function _simulate(OpenskyNetworkContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenskyNetworkContext $ctx, array $applied): void
    {
        $client = $this->client;
