...
// OpenskyNetwork SDK Flight entity
...
class FlightEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FlightEntity($this->_client, $opts);
    }

    /**
     * @param Flight|array $args Flight data (assoc-array) to store.
     */
    ...
    /**
     * @return Flight|array The current Flight data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Flight fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Flight fields).
     */
    ...
    /**
     * List Flight items matching the given filter.
     *
     * @param FlightListMatch|array|null $reqmatch Match filter (any subset
     *   of Flight fields) as an assoc-array; FlightListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Flight[]|array A list of Flight items as assoc-arrays at
