...
// OpenskyNetwork SDK Track entity
...
class TrackEntity
{
     ...
     *
     * @param TrackListMatch|array|null $reqmatch Match filter (any subset
     *   of Track fields) as an assoc-array; TrackListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Track[]|array A list of Track items as assoc-arrays at
