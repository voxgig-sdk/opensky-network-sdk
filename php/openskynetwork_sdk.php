...
class OpenskyNetworkSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = OpenskyNetworkHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = OpenskyNetworkHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!OpenskyNetworkFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, OpenskyNetworkFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return OpenskyNetworkUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = OpenskyNetworkHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = OpenskyNetworkHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = OpenskyNetworkHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new OpenskyNetworkError($op . "_allow",
                "OpenskyNetworkSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = OpenskyNetworkHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new OpenskyNetworkError("graphql_error",
                "OpenskyNetworkSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Flight($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_flight === null) {
                $this->_flight = new FlightEntity($this, null);
            }
            return $this->_flight;
        }
        return new FlightEntity($this, $data);
    }
    ...
    public function StateVector($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_state_vector === null) {
                $this->_state_vector = new StateVectorEntity($this, null);
            }
            return $this->_state_vector;
        }
        return new StateVectorEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new OpenskyNetworkSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
