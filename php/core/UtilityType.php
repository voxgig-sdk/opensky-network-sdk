...
// OpenskyNetwork SDK utility type

class OpenskyNetworkUtility
{
    ...
    public static function copy(OpenskyNetworkUtility $src): OpenskyNetworkUtility
    {
        $u = new OpenskyNetworkUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
